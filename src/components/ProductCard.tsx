      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-20 lg:max-w-7xl lg:px-8">
        <div className="group relative">
          ...
          <div className="mt-4 flex space-x-4 justify-between">
            <button onClick={handleAddClick} className={`flex items-center px-4 py-2 text-white text-sm font-medium rounded-md ${isAdded ? 'bg-green-600 hover:bg-green-700' : 'bg-gray-600 hover:bg-black'}`}>
