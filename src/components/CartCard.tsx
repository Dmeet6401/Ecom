    ...
    return (
        <div className="rounded-lg border border-black p-4 shadow-sm md:p-6">
            ...
            <div className="flex items-center justify-between md:order-3 md:justify-end">
                ...
                <button type="button" className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-gray-700 rounded-md hover:bg-black focus:outline-none focus:ring-2 focus:ring-black">
                    Checkout
                </button>
                </div>
            </div>
